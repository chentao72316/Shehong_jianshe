...
const DEFAULT_ROLE_CONFIGS = [
  ...
  { role: 'DISTRICT_MANAGER', label: '区县经理',       visibilityScope: 'all',      description: '看全部工单' },
  { role: 'DEPT_MANAGER',     label: '部门经理',       visibilityScope: 'grid',     description: '看本部门/网格的工单' },
  { role: 'LEVEL4_MANAGER',   label: '四级经理',       visibilityScope: 'grid',     description: '看本部门/网格的工单' },
  { role: 'DESIGN',           label: '设计',           visibilityScope: 'assigned', description: '只看指派给自己的工单' },
  { role: 'CONSTRUCTION',     label: '施工',           visibilityScope: 'assigned', description: '只看指派给自己的工单' },
  { role: 'SUPERVISOR',       label: '监理',           visibilityScope: 'assigned', description: '只看指派给自己的工单' },
